...
class SnapList extends StatefulWidget {
  ...
  ///Method to manually trigger focus to an item. Call with help of `GlobalKey<SnapListState>`.
  ...
  ///
  ///Input parameter is distance between item position and center of SnapList (Negative for left side, positive for right side)
  ///
  ...
  @override
  SnapListState createState() => SnapListState();
}

class SnapListState extends State<SnapList> {
  ...
  double calculateScale(int index) {
    //scroll-pixel position for index to be at the center of SnapList
